...
public class UpdateEvent extends Base{
	public static void main(String[] args) throws MalformedURLException {
		...
		el11.click();
		MobileElement el21 = (MobileElement) driver.findElementById("com.example.e_event:id/nav_event");
		el21.click();
		MobileElement el3 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout");
		el3.click();
		MobileElement el4 = (MobileElement) driver.findElementById("com.example.e_event:id/edev_et_judul");
		el4.sendKeys("Pentas seni usk");
		el4.click();
		driver.navigate().back();
		MobileElement el5 = (MobileElement) driver.findElementById("com.example.e_event:id/edev_btn_daftar");
		el5.click();
	}
}
